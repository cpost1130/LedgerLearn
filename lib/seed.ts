...
const MODULES: ModuleSeed[] = [
  ...
  },
  {
    ...
    slug: MODULE_4_SLUG,
    description:
      "Covers bank reconciliation, the Profit & Loss statement, and the Balance Sheet — checking the books and reporting results, following Maria's Bakery, including a glossary, practice exercises, and an interactive reconciliation exercise.",
    orderIndex: 4,
    dripDelayDays: 0,
